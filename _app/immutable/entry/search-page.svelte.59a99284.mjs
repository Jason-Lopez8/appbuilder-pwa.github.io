import{S as We,b as qe,a as De,a5 as _e,m as y,C as me,c as $,w as R,e as z,p as k,q as C,D as ge,k as h,d as x,x as V,u as b,f as w,E as be,I as g,Z as ye,M as J,a3 as Ne,y as N,a6 as Ae,j as ke,g as Se,F as Ce,r as Ke,Q as Fe,R as Me,n as j}from"../chunks/index.32c220d4.mjs";import{d as Ge,r as Ue,b as Je}from"../chunks/view.4966b5c6.mjs";import{S as ze}from"../chunks/SearchIcon.b30f0748.mjs";import{N as He}from"../chunks/Navbar.96034f55.mjs";const Ee=async(r,e)=>{const t=await(await fetch("/data/proskomma",{method:"POST",body:JSON.stringify({query:Ze(r)}),headers:{"content-type":"application/json",accept:"application/json"}})).json();return e&&e(t),t};function Ze(r){return r.replace(/\n/g," ").replace(/([^\w])(\s+)/g,"$1")}var D={},Z={},X={};Object.defineProperty(X,"__esModule",{value:!0});X.default=void 0;var Xe=r=>{var{cv:e}=r;return`{
    nDocSets nDocuments
    docSets {
      id
      tagsKv { key value }
